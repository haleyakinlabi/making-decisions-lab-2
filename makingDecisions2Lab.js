...
let lastItemRemoved = numArr.pop()
  console.log(numArr)
  console.log(lastItemRemoved, numArr)


////////// PROBLEM 3 //////////

// Do not edit the code below.
let familyArr = ['Tyler', 'Jordan', 'Ryan', 'Alice', 'Ireland'];
// Do not edit the code above.
//Example: 
	//let numArr = [1, 2, 3, 4, 5]
	//for (let i = 0; i < numsArr .length; i++) {
	//numsArr[i] += 1
	//the += operator is the same as saying numsArr[i] = 
	//numsArr[i] + 1
	//}
	//After the for loop runs, numsArr will look like this: 
	//[2, 3, 4, 5, 6] 
...
//Code Here
let byThree = []
for (let y = 0; y < listOfNumbers.length; y++){
  let three = listOfNumbers[y]
  if (three % 3 === 0) {
    byThree.push(three)
  }
}
...
//Code Here
for (let l = letters.length; l >= 0; l--){
...
//Code Here
for (let x = 0; x < 100; x++){
  // if divisible by 3 then print 'dev'
  if (( x % 3 === 0) && (x % 5 === 0)){
    console.log(x, 'devmountain')
  } else if (x % 3 === 0){
    console.log(x, 'dev')
  } else if (x % 5 === 0){
    console.log(x, 'mountain')
  } else {
    console.log(x)
  }
  // if divisible by 5 then print 'mountain'
  // if divisible by 3 & 5 then print 'devmountain' 
  // if not divisible by 3 and 5 then console.log the number itself
}